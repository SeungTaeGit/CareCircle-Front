...
export default function MessageAlert({ message, partnerInfo, onRead }: MessageAlertProps) {
  ...
  if (!message) {
    return (
      <div className="w-full bg-amber-50 rounded-3xl p-5 border-2 border-amber-200 shadow-sm transition-all duration-500 flex flex-col items-center text-center relative">
        {feedbackUI}
  ...
  return (
    <div className="w-full bg-amber-50 rounded-3xl p-5 border-2 border-amber-200 shadow-sm transition-all duration-500 relative">
      {feedbackUI}
